...
public class Result implements Comparable<Result> {
     ...
     */
    public Result(final String documentPath, final double rank, final int lengthOfLongestWord, final int numberOfLongestWords) {
    ...
    public String toOutputFormat() {
        return Paths.get(documentPath).getFileName() + "," + String.format("%.2f,", rank) + lengthOfLongestWord + "," + numberOfLongestWords;
    }
    @Override
